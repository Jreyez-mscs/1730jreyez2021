...
namespace LogicalOperationsUnitTests
{
    [TestClass]
    public class LogicalOperationsUnitTests
    {
        ...
        [TestMethod]
        public void TestQ10FailCnotlessthanD()
        {
            Assert.IsFalse(LogicalOperations.q10(1, 1, 4, 4));
        }
        [TestMethod]
        public void TestQ10FailLessthanD()
        {
            Assert.IsTrue(LogicalOperations.q10(1, 1, 3, 4));
        }
        [TestMethod]
        public void TestQ10FailBInRange()
        {
            Assert.IsTrue(LogicalOperations.q10(2, 1, 3, 2));
        }
