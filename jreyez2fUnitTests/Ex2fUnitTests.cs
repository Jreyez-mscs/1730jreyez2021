...
namespace jreyez2fUnitTests
{
    [TestClass]
    public class Ex2fUnitTests
    {
        // Paste these 'test' methods into the class named Ex2fUnitTests.cs
	// (paste the entire contents of this file into the class in Ex2fUnitTests)	
	...
	[TestMethod]
        ...
        {
            Assert.AreEqual("Standard rate: 0.00", Ex2fCalculations.Calc02("99.99"));
        }
        [TestMethod]
        ...
        {
            Assert.AreEqual("0.40", Ex2fCalculations.Calc03("99.99"));
        }
        [TestMethod]
        ...
        {
            Assert.AreEqual("20000.00", Ex2fCalculations.Calc07("100.00"));
        }
        [TestMethod]
        public void Test08AInputEmpty()
        {
            Assert.AreEqual("Invalid input", Ex2fCalculations.Calc08("", ""));
        }
        [TestMethod]
        ...
        {
            Assert.AreEqual("54.98", Ex2fCalculations.Calc08("24.99", "2"));
        }
        [TestMethod]
        public void Test08TotalGE50()
        {
            Assert.AreEqual("50.00", Ex2fCalculations.Calc08("25.00", "2"));
        }
        [TestMethod]
        ...
        {
            Assert.AreEqual("2", Ex2fCalculations.Calc10("4", "2"));
        }
        [TestMethod]
        public void Test10Valid2Div4()
        {
            Assert.AreEqual("2", Ex2fCalculations.Calc10("2", "4"));
        }
        [TestMethod]
        public void Test10Valid4Div4()
        {
            Assert.AreEqual("1", Ex2fCalculations.Calc10("4", "4"));
        }
    }
}
