<% @ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="jreyez2hh1._Default" %>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox7" runat="server" Enabled="True" Text="November 1, 2019"></asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox9a" runat="server" Enabled="True">1/13/2013</asp:TextBox>
                <asp:TextBox ID="TextBox9b" runat="server" Enabled="True">12/12/2012</asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox10a" runat="server" Enabled="True">1/13/2013</asp:TextBox>
                <asp:TextBox ID="TextBox10b" runat="server" Enabled="True">12/13/2012</asp:TextBox>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <asp:Button ID="Button1" runat="server" Text="StringCalculationButton" OnClick="Button1_Click" />
            </div>
        </div>
